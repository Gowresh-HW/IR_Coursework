...
class Controller:
    ...
    def sense_compute_and_actuate(self):
        ...
        if(len(self.inputs) > 0 and len(self.inputsPrevious) > 0):
            ...
            elif(self.dist[0] > 0.08 and self.dist[2] > 0.08 and self.dist[5] > 0.08 and self.dist[7] > 0.08):
                print("Stop");
                self.velocity_left = 0;
                self.velocity_right = 0;
                
            elif(self.dist[0] > 0.1 and self.dist[7] > 0.1) :
                if(self.flag_turn):
                    print("Turn Right");
                    self.velocity_left = 0.3;
                    self.velocity_right = -0.3;
